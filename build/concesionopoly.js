...
},{"./templates":4,"deepmerge":9}],4:[function(require,module,exports){
'use strict';
...
},{"fly-template":11}],5:[function(require,module,exports){
'use strict';
...
var Dices = (function () {
  ...
  _createClass(Dices, [{
    key: 'flip',
    value: function flip() {
      var values = (0, _immutable.Repeat)(null, this.amount).map(function () {
...
},{"immutable":12}],6:[function(require,module,exports){
'use strict';
...
var Engine = (function (_Emitter) {
  ...
  _createClass(Engine, [{
    ...
    value: function removeLastProperty() {
      var property = this.state.ownedProperties.last();
    ...
    value: function doTurn() {
      ...
      if (this.position >= _tiles2['default'].size - 1) {
...
},{"./dices":5,"./tiles":7,"emitter":10,"immutable":12}],7:[function(require,module,exports){
'use strict';
...
},{"immutable":12}],8:[function(require,module,exports){
'use strict';
